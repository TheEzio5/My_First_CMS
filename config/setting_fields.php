    ...
    'app' => [
        ...
        'elements' => [
            ...
            [
                ...
                'class' => '', // any class for input
                'value' => '<a href="/">Built in Croatia</a>', // default value if you want
            ],
            [
    ...
    'meta' => [
        ...
        'elements' => [
            ...
            [
                ...
                'rules' => 'required', // validation rule of laravel
                'class' => '', // any class for input
                'value' => 'Simple CMS Created using Laravel with all need requirements, #AlgebraCrew', // default value if you want
            ],
            [
                'type'  => 'text', // input fields type
                'data'  => 'text', // data type, string, int, boolean
                ...
                'rules' => 'required', // validation rule of laravel
                'class' => '', // any class for input
                'value' => 'Web Application, AlgebraCrew', // default value if you want
            ],
            [
                'type'  => 'text', // input fields type
                'data'  => 'text', // data type, string, int, boolean
