<div class="py-10" x-data="{ commentBlock: false }">
    <div class="container mx-auto px-5">
        ...
        <div class="py-10 flex justify-center">
            <div>
                <a href="{{route('login')}}?redirectTo={{url()->current()}}" class="btn btn-primary">{{__('Logiraj se i komentiraj')}}</a>
            </div>
        </div>
        @else
        <div class="flex justify-center mx-auto">
            <div>
                <button class="btn btn-primary" @click="commentBlock = !commentBlock">{{__('Napiši komentar')}}</button>
            </div>
        </div>
        ...
        <div x-show="commentBlock" x-collapse>
            <div>
                <div class="flex justify-center mx-auto">
                    ...
                    Tvoj komentar je na čekanju.Ukoliko tvoj komentar bude odobren, dobiti češ obavjest te če on biti prikazan ovdje.
                        <br>
                        Molim podnesi i čekaj dok se ne objavi.
                    </div>
                </div>
                ...
                <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Potvrdi</button>
                {{ html()->form()->close() }}
            </div>
