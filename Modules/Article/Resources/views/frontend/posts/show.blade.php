        ...
        <div class="flex flex-col lg:flex-grow sm:w-8/12 sm:pr-8">
            ...
            <div class="py-5">
                <div class="flex justify-between font-bold">
                    <div>
                        {{__('Objavio korisnik')}}: {{isset($$module_name_singular->created_by_alias)? $$module_name_singular->created_by_alias : $$module_name_singular->created_by_name}}
                    </div>
                    <div>
                        {{__('Objavljeno datuma:')}}: {{$$module_name_singular->published_at->isoFormat('llll')}}
                    </div>
                </div>
            </div>
            ...
            <div class="py-5">
                <div class="flex flex-row justify-around content-center items-center ">
                    <h6 class="">Podijeli sa drugima</h6>
