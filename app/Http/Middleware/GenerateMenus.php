...
class GenerateMenus
{
    ...
    public function handle($request, Closure $next)
    {
        \Menu::make('admin_sidebar', function ($menu) {
            // Dashboard
            $menu->add('<i class="nav-icon cil-speedometer"></i> '.__('Nadzorna ploča'), [
            ...
            // Notifications
            $menu->add('<i class="nav-icon fas fa-bell"></i> Obavijesti', [
            ...
            // Settings
            $menu->add('<i class="nav-icon fas fa-cogs"></i> Postavke', [
            ...
            // Submenu: Users
            $accessControl->add('<i class="nav-icon cil-people"></i> Korisnici', [
            ...
            // Submenu: Roles
            $accessControl->add('<i class="nav-icon cil-people"></i> Uloge', [
            ...
            $accessControl->add('<i class="nav-icon cil-list"></i> Nadzorna ploča', [
