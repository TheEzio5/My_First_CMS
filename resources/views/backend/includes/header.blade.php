    ...
    <div class="container-fluid">
        ...
        <ul class="header-nav ms-auto">
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end pt-0">
                    <div class="dropdown-header bg-light py-2">
                        <strong>@lang("Imaš :count notifications", ['count'=>$notifications_count])</strong>
                    </div>
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end pt-0">
                    <div class="dropdown-header bg-light py-2">
                        <div class="fw-semibold">{{ __('Korisnički račun') }}</div>
                    </div>
                    ...
                    <a class="dropdown-item" href="{{ route("backend.notifications.index") }}">
                        ...
                        @lang('Obavijesti') <span class="badge bg-danger ml-auto">{{$notifications_count}}</span>
                    </a>

                    <div class="dropdown-header bg-light py-2"><strong>@lang('Postavke')</strong></div>
