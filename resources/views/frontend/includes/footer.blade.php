    ...
    <div class="max-w-screen-xl px-4 py-12 mx-auto sm:px-6 lg:px-8">
        <div class="max-w-3xl mx-auto space-y-6">
            <div class="flex justify-center space-x-6">
                <a class="text-blue-500 hover:text-opacity-75" href="https://twitter.com/TheEzio5" target="_blank" rel="noopener noreferrer" aria-label="Twitter">
                ...
                <a class="text-gray-900 hover:text-opacity-75" href="https://github.com/TheEzio5" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="w-8 h-8" viewBox="0 0 18 18">
            ...
            <p class="max-w-lg mx-auto text-xs text-gray-500">
               Kreirano u svrhu projekta za završni ispit #Algebra
            </p>
